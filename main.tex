...
Our analysis also highlighted the top Autonomous Systems (ASes) based on the number of matches and mismatches. Table \ref{tab:match_mismatch}
presents the top ASes in each category.
\begin{table}[h!]
    \centering
    \begin{tabular}{|l|r|}
        \hline
